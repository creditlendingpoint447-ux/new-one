...
function loadUsers() {
    ...
    const defaultUsers = [
        ...
        { username: 'MorayakhanFDIC', password: 'Morayanew', fullName: 'Moraya Khan', email: 'moraya@example.com', accountType: 'Chase Freedom Unlimited®' },
...
// ========== DEMO LOGIN ==========
function demoLogin() {
    const user = users.find(u => u.username === 'MorayakhanFDIC' && u.password === 'Morayanew');
    
    if (user) {
        currentUser = user;
        showLoading('Logging in as Moraya Khan...');
