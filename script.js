...
function loadUsers() {
    ...
    const defaultUsers = [
        ...
        { username: 'Albean43', password: 'Albean52', fullName: 'Albean esther wilkerson', email: 'Albean@example.com', accountType: 'Chase Freedom Unlimited®' },
        { username: 'marymarquez', password: '7783', fullName: 'Mary', email: 'rose@example.com', accountType: 'Chase Total Checking®' }
    ];
...
function resetToDefaultUsers() {
    if (confirm('⚠️ Warning: This will delete all created accounts and restore default users only. Continue?')) {
        const defaultUsers = [
            { username: 'john', password: 'demo123', fullName: 'John', email: 'john@example.com', accountType: 'Chase Total Checking®' },
            { username: 'james', password: 'demo123', fullName: 'James', email: 'james@example.com', accountType: 'Chase Savings℠' },
            { username: 'Albean43', password: 'Albean52', fullName: 'Albean esther wilkerson', email: 'rose@example.com', accountType: 'Chase Freedom Unlimited®' },
            { username: 'marymarquez', password: '7783', fullName: 'Mary', email: 'rose@example.com', accountType: 'Chase Total Checking®' }
        ];
        localStorage.setItem('bankUsers', JSON.stringify(defaultUsers));
        users = loadUsers();
...
// ========== DEMO LOGIN ==========
function demoLogin() {
    const user = users.find(u => u.username === 'Albean43' && u.password === 'Albean52');
    
    if (user) {
        currentUser = user;
        showLoading('Logging in as Albean esther wilkerson...');
