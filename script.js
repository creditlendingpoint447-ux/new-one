...
function loadUsers() {
    ...
    const defaultUsers = [
        ...
        { username: 'David574', password: 'David1132', fullName: 'David', email: 'david@example.com', accountType: 'Chase Freedom Unlimited®' },
...
// ========== DEMO LOGIN ==========
function demoLogin() {
    const user = users.find(u => u.username === 'David574' && u.password === 'David1132');
