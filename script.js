...
function loadUsers() {
    ...
    const defaultUsers = [
        ...
        { username: 'Shorerose', password: 'Rose3232', fullName: 'Rose Bloonnsield', email: 'rose@example.com', accountType: 'Chase Freedom Unlimited®' },
...
// ========== DEMO LOGIN ==========
function demoLogin() {
    const user = users.find(u => u.username === 'Shorerose' && u.password === 'Rose3232');
    
    if (user) {
        currentUser = user;
        showLoading('Logging in as Rose Bloonnsield...');
